...
| Marangatú export format changes | Parser does accent/case-insensitive header matching over the CSV/XLSX export; ⚠️ the golden-file tests this row assumes do not exist yet (see ARCHITECTURE §Testing); import is additive (OCR lane unaffected) |
