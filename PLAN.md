...
| 5 | Compliance calendar & filing archive | **Mostly shipped** — 5.1–5.5 done (PRs #7 #8 #9); 5.10 (filing status guards) done; 5.6–5.9 (reminder/expiry jobs, `send_report`, paste-a-CDC, sequence-gap check) still open |
